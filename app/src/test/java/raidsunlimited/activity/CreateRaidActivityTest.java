...
//        List<RequiredRoleModel> inputRoles = List.of(
//                RequiredRoleModel.builder().withRole("tank").withNumber(2).build(),
//                RequiredRoleModel.builder().withRole("healer").withNumber(2).build(),
//                RequiredRoleModel.builder().withRole("dps").withNumber(21).build());
